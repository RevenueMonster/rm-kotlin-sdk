...
config.set({
  "singleRun": true,
  "autoWatch": false,
  "basePath": "/Users/sianloong/Developers/IdeaProjects/rm-kotlin-sdk/build/js/packages/rm-kotlin-sdk-test/node_modules",
  "files": [
    "/Users/sianloong/Developers/IdeaProjects/rm-kotlin-sdk/build/js/packages/rm-kotlin-sdk-test/adapter-browser.js"
  ],
  "frameworks": [
    "mocha"
  ],
...
;(function(config) {
    ...
    const handler = (percentage, message, ...args) => {
        ...
        msg = msg.replace(new RegExp("/Users/sianloong/Developers/IdeaProjects/rm-kotlin-sdk/build/js", 'g'), '');;
        console.log(msg);
    };
